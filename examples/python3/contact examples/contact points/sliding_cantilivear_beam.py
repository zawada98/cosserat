...
RADIUS1          = 5.0      # [mm]  cross-section radius
RADIUS2          = 1.0      # [mm]  cross-section radius
...
GAP_Z = 10.0    # [mm]   must be > 2*RADIUS to start without interpenetration
GAP_Y = 2.0
...
def createScene(root_node: Sofa.Core.Node):
    ...
    add_visual_model(beam1_framesNode, beam1_frames, RADIUS1)
    ...
    add_visual_model(beam2_framesNode,beam2_frames, RADIUS2)
