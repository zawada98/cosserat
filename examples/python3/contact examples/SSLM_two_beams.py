...
ALGORITHM        = "ALGO_2" # "ALGO_1" (segment-seg) or "ALGO_2" (node-seg NR)
DT               = 0.01     # [s]   time step
...
def createScene(root_node: Sofa.Core.Node):
    ...
    ssim = solver_node.addObject(
        ...
        name            = 'ssim',
        beam1Frames     = beam1_framesNode.FramesMO.position.getLinkPath(),
        beam2Frames     = beam2_framesNode.FramesMO.position.getLinkPath(),
        radius1         = RADIUS,
        radius2         = RADIUS,
    ...
    root_node.addObject(SSIMPlotter(
        root_node       = root_node,
        ssim_component  = ssim,
        beam1_frames_mo = beam1_framesNode.FramesMO,
        beam2_frames_mo = beam2_framesNode.FramesMO,
        algorithm       = ALGORITHM,
